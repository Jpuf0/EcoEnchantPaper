...
public class TelekinesisLogic {
    public static void tryTelekinesis(World world, BlockPos blockPos, BlockState blockState, PlayerEntity playerEntity) {
...
//        boolean hasAutoSmelt = Registry.ENCHANTMENT.AUTOSMELT.hasEnchantment(Item);
        ...
        doTelekinesis(world,blockPos,blockState,playerEntity,Item);
    }

    private static int doTelekinesis(World world, BlockPos blockPos, BlockState blockState, PlayerEntity playerEntity, ItemStack item) {
